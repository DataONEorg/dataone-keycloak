...
- Report a bug or request a new feature in our [issue tracker](https://github.com/DataONEorg/dataone-keycloak/issues)
...
- add an [issue](https://github.com/DataONEorg/dataone-keycloak/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [repository](https://github.com/DataONEorg/dataone-keycloak)
...
Development is managed through the git repository at https://github.com/DataONEorg/dataone-keycloak.  The repository is organized into several branches, each with a specific purpose.  
...
3. Releases can be downloaded from the [GitHub releases page](https://github.com/DataONEorg/dataone-keycloak/releases).
