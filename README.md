...
| `keycloakx.extraInitContainers`                | Additional init containers, e.g. for providing custom themes and providers       | `see values.yaml`                                         |
| `keycloakx.command`                            | Overrides the default entrypoint of the Keycloak container                       | `["sh"]`                                                  |
| `keycloakx.args`                               | Command args override the default entrypoint of the Keycloak container           | `see values.yaml`                                         |
| `keycloakx.extraEnv`                           | Additional environment variables for Keycloak                                    | `see values.yaml`                                         |
